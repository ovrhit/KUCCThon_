...
export const MOCK_TARGETS: Target[] = [
  { id: "me", name: "나 자신", description: "오늘의 나에게 하는 한마디", color: "bg-black", slug: "me" },
  { id: "parents", name: "부모님", description: "세상에서 가장 소중한 분들", color: "bg-orange-400", slug: "parents" },
  { id: "friend-1", name: "민수", description: "함께 있으면 즐거운 친구", color: "bg-blue-500", slug: "friend-1" },
  { id: "lover", name: "연인", description: "언제나 내 편인 사람", color: "bg-rose-400", slug: "lover" },
];
...
export function resolveTargetId(idOrSlug: string): string {
  const target = MOCK_TARGETS.find(t => t.id === idOrSlug || t.slug === idOrSlug);
