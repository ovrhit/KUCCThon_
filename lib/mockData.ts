...
export const MOCK_TARGETS: Target[] = [
  ...
  { id: "00000000-0000-0000-0000-000000000003", name: "민수", description: "함께 있으면 즐거운 친구", color: "bg-blue-500", slug: "friend-1" },
  { id: "00000000-0000-0000-0000-000000000004", name: "연인", description: "언제나 내 편인 사람", color: "bg-rose-400", slug: "lover" },
];
